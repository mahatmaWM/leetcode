...
# @lc code=start
class Solution:
    # 思路，由于输入确保在 1 到 3999 的范围内，所以可以每位数字单独判断。
    def intToRoman(self, num: int) -> str:
        ...
        str_ge = judge(ge, "I", "V", "X")
        str_shi = judge(shi, "X", "L", "C")
        str_bai = judge(bai, "C", "D", "M")
        str_qian = judge(qian, rm1="M")
